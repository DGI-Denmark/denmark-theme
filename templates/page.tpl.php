...
<div id="header-wrapper">
  <div id="header"><div class="section clearfix">
    ...
    <?php if ($logo): ?>
      <a href="<?php print ( $denmark_logo_link ? $denmark_logo_link : $front_page); ?>" title="<?php print t('Home'); ?>" rel="home" id="logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
    <?php endif; ?>

    <?php if($cdio_logo): ?>
      <div class="cdio-logo"></div>
    <?php endif; ?>
    ...
    <div class="dtu-logo"><a href="http://www.dtu.dk/"><img src="<?php print $base_url . '/'. $directory; ?>/images/default/dtu-logo-red.png"></a></div>
